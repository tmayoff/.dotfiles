...
# zstyle ':omz:update' mode disabled***REMOVED*** disable automatic updates
# zstyle ':omz:update' mode auto    ***REMOVED*** update automatically without asking
# zstyle ':omz:update' mode reminder***REMOVED*** just remind me to update when it's time
